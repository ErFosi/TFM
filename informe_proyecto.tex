...
\begin{itemize}
    ...
    \item \textbf{Agente de actualización en dispositivo:} Cliente basado en SWUpdate extendido con soporte para ASCON (LWC) y MLDSA (PQC) para dispositivos Linux embebido.
\end{itemize}
...
\begin{itemize}
    ...
    \item Soporte para firma digital tradicional (RSA, ECDSA) y post-cuántica (MLDSA)
...
\begin{itemize}
    ...
    \item SWUpdate modificado con ASCON y MLDSA
